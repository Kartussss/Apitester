...
<template>
    <header :class="sectionColor+' w3-container'"> <H2>Dictionary ADD</H2></header>
         ...
         <div class="col-lg-5 col-4">
            <form @submit="submitForm">
                ...
                <div class="form-group">
                    <label :for="subsection+'Text'">Insert phrase</label>
                    <textarea :id="subsection+'Text'" class="form-control" v-model="form.phrase" />
                </div>
                <div class="form-group">
