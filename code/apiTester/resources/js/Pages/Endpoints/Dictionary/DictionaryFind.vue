...
<template>
    <header :class="sectionColor+' w3-container'"> <H2>Dictionary Find</H2></header>
                ...
                <div class="form-row">
                    <div class="col">
                        <div class="form-group">
                            <label :for="subsection+'LeftContext'">Insert left Context</label>
                            <textarea :id="subsection+'LeftContext'" class="form-control" v-model="form.leftContext" />
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                    ...
                    <div class="col">
                        <div class="form-group">
                            <label :for="subsection+'RightContext'">Insert right Context</label>
                            <textarea :id="subsection+'RightContext'" class="form-control" v-model="form.rightContext" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
