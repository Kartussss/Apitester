...
<template>
    <header :class="sectionColor+' w3-container'"> <H2>WordPrediction Predict</H2></header>
    <div :class="'form-row '+ subsection" >
        <div class="col-6">
            <form @submit="submitForm">
                <div class="form-row">
                    <div class="col">
                        <label :for="subsection+'Lang'">Select language</label>
                        <select class="form-control" :id="subsection+'FromLang'" v-model="form.lang">
                    ...
                    <div class="col">
                        <label :for="subsection+'pos'">Insert Position</label>
                        <input type="number" :id="subsection+'pos'" class="form-control" v-model="form.pos" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label :for="subsection+'User'">Insert User Id</label>
                    <textarea :id="subsection+'User'" class="form-control" v-model="form.user" />
                </div>
                <div class="form-group">
