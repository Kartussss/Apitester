...
<template>
    <header :class="sectionColor+' w3-container'"> <H2>Delete allowed word</H2></header>
            ...
            <form @submit="submitForm">
                <div class="form-row">
                    <div class="col">
                        ...
                        <select class="form-control" :id="subsection+'Lang'" v-model="form.lang">
                ...
                <div class="form-group">
                    <label :for="subsection+'Word'">Insert word</label>
                    <textarea :id="subsection+'Word'" class="form-control" v-model="form.word" />
                </div>
                <div class="form-group">
